...
function isExtraordinaryGroup(name: string): boolean {
  ...
  return (
    <div className="space-y-6">
      ...
      {(() => {
        ...
        return vm.groups.map((group, index) => {
          const groupName = groupTitles[group.groupData] || group.groupData;
          const isExtra = isExtraordinaryGroup(group.groupData);
          const showSeparator = isExtra && !renderedExtraHeader && index > 0;
            ...
            <Fragment key={group.groupId}>
              {showSeparator && (
                <div className="py-4 flex items-center gap-4">
                  ...
                  <span className="text-[11px] font-extrabold uppercase tracking-widest text-cyan-700 bg-cyan-50 border border-cyan-100 rounded-full px-4 py-1.5 shadow-sm">
